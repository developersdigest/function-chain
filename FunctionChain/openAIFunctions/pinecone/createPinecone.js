...
export const execute = async ({ indexName: paramIndexName }) => {
...
export const details = {
    ...
    parameters: {
        ...
        properties: {
            indexName: {
                type: 'string',
                description: 'The name of the index to be created or checked. If not provided, it will default to the value specified in the .env file.',
            },
        },
    },
