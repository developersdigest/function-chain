...
async function runAllExamples() {
  ...
  let res9 = await functionChain.call(
  ...
  let res10 = await functionChain.call(
  ...
  let res11 = await functionChain.call(
    "Classify an image of a cat",
    huggingFaceImageClassification
  );
